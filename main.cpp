...
//
  ...
  void initSystem(int argc, char * argv[])
  {
    ...
    case 't': timeStepper = new Trapzoidal(); break;
  ...
  void drawSystem()
  {
    ...
    void keyboardFunc( unsigned char key, int x, int y )
    {
        ...
        case 't':
        {
            // Delete existing systems before creating a new one
            delete system; // Make sure system is a pointer that can cover all types (e.g., base class pointer)
            system = NULL; // Reset the pointer to null after deleting

            delete pendulumSystem;
            pendulumSystem = NULL;
